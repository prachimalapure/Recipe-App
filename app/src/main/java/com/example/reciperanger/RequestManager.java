...
public class RequestManager {
    ...
    public void getRecipeDetails(RecipeDetailsListener listener,int id){
        ...
        Call<RecipeDetailsResponse> cal = callRecipeDetails.callRecipeDetails(id,context.getString(R.string.api_key));
        cal.enqueue(new Callback<RecipeDetailsResponse>() {
            @Override
    ...
    public void getInstructions(IntructionsListeners listener ,int id){
